 ...
 * All rights reserved.
 *
 * Date: Sat Jul 6 22:32:59 2013 +0200
 *
 ***
 *
	...
	return Base.each(types, function(properties, type) {
		...
		_adjust: function(amt) {
			...
			if( type === 'hsl' || type === 'hsb' ) {
				var components1 = this._components;
				console.log( 'hsl- b', components1.length );
			}
			else {
				this._convert('hsb');
				var components1 = this._components;
				console.log( 'else', components1.length );
			}
		...
		lerp: function( arg0, arg1, arg2 ) {
			...
			if(typeof arg1 === 'number') {
				...
				for( var i=0; i<comps.length; i++ ) {
					comps[i] = paper.lerp( comps[i],	acomps[i], arg1);
				}
			}
			else {
				var acomps = arg0.getComponents();
				...
				for( var i=0; i<acomps.length; i++ ) {
					comps[i] = paper.lerp( acomps[i],	bcomps[i], arg2);
				}
			}
