...
function Setup() {
	...
	var triangle = new fshape.FTriangle( 
		new Point( 100,100 ),
...
function Draw() {
	...
	// triangle
	triangle.fillColor = new paper.RGBColor( 0.98, 0.98, 0.98 );
