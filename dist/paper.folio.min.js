...
(function(){var J="undefined"!==typeof global&&null!==global?global:this,m={body:document.body,html:document.documentElement,FTime:{},FIO:{},F3D:{}};paper.install(window);PaperScope.inject({enumerable:!0,print:function(f){console.log(f)},println:function(f){console.log(f);console.log("\n")},boolToInt:function(f){return f?1:0},numToBool:function(f){return 0!==f?!0:!1},getType:function(f){return f instanceof Point?"Point":f instanceof Size?"Size":f instanceof Rectangle?"Rectangle":f instanceof Group?
